...
var to_object_plugin_1 = require("../plugins/to-object-plugin");
...
var ClassTransformer = (function () {
    ...
    ClassTransformer.prototype.transform = function (type, values) {
        var _type = type instanceof type_mirror_1.TypeMirror ? type : type_mirror_1.TypeMirror.createObjectMirror(type);
        var Plugin = allPlugins.get(_type.type()) || to_object_plugin_1.ToObjectPlugin;
